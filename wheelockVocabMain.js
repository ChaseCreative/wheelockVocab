...
function userInputValue(){
  ...
  console.log(x);
  if (x==1){
    vocArry =[["me","me, myself"],["quid","what"],["nihil","nothing"],["nōn","not"],["saepe","often"],["sī","if"],["amō, amāre, amāvī, amātum","to love, like"],["cōgitō, cōgitāre, cōgitāvī, cōgitātum","to think, ponder, consider, plan"],["dō, dāre, dedī, datum","to give, offer"],["dēbeō, dēbēre, dēbuī, dēbitum","to owe; ought, must, should"],["moneō, monēre, monuī, monitum","to remind, advise, warn"],["salveō, salvēre","to be well, be in good health"],["errō, errāre, errāvī, errātum","to wander; err, go astray, make a mistake, be mistaken"],["conservō, conservāre, conservāvī, conservātum","to preserve, conserve, maintain"],["laudō, laudāre, laudāvī, laudātum","to praise"],["vocō, vocāre, vocāvī, vocātum","to call, summon"],["salvē (salvēte)","hello, greetings"],["servō, servāre, servāvī, servātum","to preserve, save, keep, guard"],["terreō, terrēre, terruī, territum","to frighten, terrify"],["valeō, valēre, valuī,valiturum","to be strong, have power; be well"],["videō, vidēre, vīdī, visum","to see; observe,understands"],["valē (valēte)","good-bye, farewll"]];
    ...
    vocArry = [["amor, amoris, m.","love"],["carmen, carminis, n.","song, poem"],["civitās, civitātis, f.","state, citizenship"],["corpus, corporis, n.","body"],["homo, hominis, m.","man, human being"],["labor, laboris, m.","labor, work, toil; a work, production"],["littera, litterae f.","a letter of the alphabet"],["litterae, litterārum, f.","a letter"],["mōs, mōris, m.","custom, manner, manner"],["mōres, mōrum, m.","habits, morals, character"],["nōmen, nōminis, n.","name"],["pāx, pācis, f.","peace"],["regīna, regīnae, f.","queen"],["rēx, rēgis, m.","king"],["tempus, temporis, n.","time; occasion, opportunity"],["terra, terrae, f.","earth, ground, land, country"],["uxor, uxoris, f.","wife"],["virgō, virginis, f.","maiden, virgin"],["virtūs, virtūtis, f.","manliness, courage, excellence, character, worth, virtue"],["novus, nova, novum","new, strange"],["post (+ ACC)","after, behind"],["sub (+ ABL.)","under"],["sub (+ ACC.)","under, up under, close to; down to/into, to/at the foot of"],["audeō, audēre, ausus sum","to dare"],["necō, necāre, necāvī, necātum","to murder, kill"]];

  } else if (x==8){
      vocArry = [["lībertās, lībertātis, f.","liberty"],["ratiō, ratiōnis, f.","reckoning, account; reason, judgment, consideration; system, manner, method"],["scrīptor, scrīptoris, m.","writer, author"],["soror, sorōris, f.","sister"],["victōria, victōriae, f.","victory"],["dum","while, as long as, at the same time that"],["dum + subjunctive","until"],["ad (+ ACC.)","to, up to, near"],["ex or ē (+ ABL.)","out of, from, from within; by reason of, on account of"],["numquam","never"],["tamen","nevertheless"],["agoō, agere, ēgī, actum","to drive, lead, do, act; pass, spend"],["dēmonstrō, dēmonstrāre, dēmonstrāvī, dēmonstrātum","to point out, show, demonstrate"],["discō, discere, didicī","to learn"],["doceō, docēre, docuī, doctum","to teach"],["dūcō, dūcere, dūxī, dūctum","to lead; consider; regard; prolong"],["gerō, gerere, gessī, gestum","to carry; carry on, manage; conduct, wage, accomplish, perform"],["scrībō, scrībere, scripsī, scrtiptum","to write, compose"],["trahō, trahere, trāxī, tractum","to draw, drag; derive, acquire"],["vincō, vincere, vīcī, victum","to conquer, overcome"]];
    ...
    vocArry = [["Italia, Italiae, f.","Italy"],["memoria, memoriae, f.","memory, recollection"],["tempestās, tempestātis, f.","period of time, season, weather, storm"],["centum","one hundred"],["mīlle","thousand"],["miser, misera, miserum","wrectched, miserable, unfortunate"],["inter","between, among"],["itaque","and so, therefor"],["committō, committere, commīsī, commissum","to entrust, commit"],["exspectō, exspectāre, exspectāvī, exspectātum","to look for, expect, await"],["iaciō, iacere, iēci, iactum","to throw, hurl"],["timeō, timēre, timuī","to fear, be afraid (of)"],["ūnus, ūna, ūnum","one"],["duo, duae, duo","two"],["trēs, trēs, tria","three"],["quattuor","four"],["quinque","five"],["sex","six"],["septem","seven"],["octō","eight"],["novem","nine"],["decem","ten"],["ūndecim","eleven"],["duodecim","tweleve"]["tredcim","thirteen"],["quattuordecim","fourteen"],["quīndecim","fifteen"],["sēdecim","sixteen"],["septendecim","seventeen"],["duodēvīgintī","eighteen"],["ūndēvīgintī","nineteen"],["vīgintī ūnus","twenty-one"],["prīmus, prīma, prīmum","first"],["secundus, secunda, secundum","second"],["tertius, tertia, tertium","third"],["quārtus, quārta, quārtum","fourth"],["quintus, quinta, quintum","fifth"],["sextus, sexta, sextum","sixth"],["septimus, septima, septimum","seventh"],["octāvus, octāva, octāvum","eighth"],["nōnus, nōna, nōnum","ninth"],["decimus, decima, decimum","tenth"],["ūndecimus, ūndecima, ūndecimum","eleventh"],["duodecimus, duodecima, duodecimum","twelth"]];

  } else if (x==16){
    vocArry =[["aetas, aetātis, f.","period of life, life, age, an age, time"],["audītor, audītor, m.","hearer, listener, member of an audience"],["clēmentia, clēmentiae, f.","mildness, gentleness, mercy"],["mēns, mēntis, f.","mind"],["satura, saturae, f.","satire"],["ācer, ācris, ācre","sharp, keen, eager; severe, fierce"],["brevis, brevis, breve","short, small, brief"],["celer, celeris, celere","swift, quick, rapid"],["difficilis, difficilis, difficile","difficult"],["dulcis, dulcis, dulce","sweet; pleasant, agreeable"],["facilis, facilis, facile","easy, agreeable"],["fortis, fortis, forte","strong, brave"],["ingēns, ingēns, ingēns (gen. ingentis)","huge"],["iūcundus, iūcunda, iūcundum","pleasant, delightful, agreeable"],["longus, longa, longum","long"],["omnis, omnis, omne","every, all"],["potēns, potēns, potēns (gen. potentis)","able, powerful"],["senex, senex, senex (gen. senis)","old, aged; old man"],["quam","how"],["regō, regere, rēxī, rectum","to rule, guide, direct"]];
    ...
    vocArry =[["Carthāgo, Carthāginis, f.","Carthage"],["fabula, fabulae, f.","story, tale; play"],["imperātor, imperātoris, m.","general, commander-in-chief, emperor"],["imperium, imperiī, n.","power to command, supreme power, authority, command"],["perfugium, perfugiī, n.","refuge, shelter"],["servus, servī, m.","slave"],["sōlācium, sōlāciī, n.","comfort, relief"],["vulnus, vulneris, n.","wound"],["re- or red- as prefix","again, back"],["ut","as, just as, when"],["posteā","aferwards"],["accipiō, accipere, accēpī, acceptum","to take, receive, accept"],["excipiō, excipere, excēpī, exceptum","to take out, except; take, receive, capture"],["recipiō, recipere, recēpī, receptum","to take back, regain; admit, receive"],["pellō, pellere, pepulī, pulsum","to strike, push; drive out, banish"],["expellō, expellere, expulsī, expulsum","to drive out, expel, banish"],["nārrō, nārrāre, nārrāvī, nārrātum","to tell, report, narrate"],["quaerō, quaerere, quaesīvī, quaesītum","to seek, look for, strive for; ask, inquire, inquire into"],["rīdeō, rīdēre, rīsī, rīsum","to laugh, laugh at"]];

  } else if (x==25){
    vocArry = [["lingua, linguae, f.","tongue; language"],["ferōx, ferōx, ferōx (gen. ferōcis)","fierce, savage"],["fidēlis, fidēlis, fidēle","faithful, loyal"],["geminus, gemina, geminum","twin"],["sapiēns, sapiēns, sapiēns (gen. sapientis)","wise, judicious"],["ultimus, ultima, ultimum","farthest, extreme"],["dehinc","then, next"],["hīc","here"],["āit, āiunt","he says, they say, assert"],["crēdō, crēdere, crēdidī, crēditum (+ DAT.)","believe, trust"],["negō, negāre, negāvī, negātum","to deny, say that ... not"],["iaceō, iacēre, iacuī","to lie; lie prostrate; lie dead"],["nesciō, nescīre, nescīvī, nescītum","to not know, be ignorant"],["patefaciō, patefacere, patefēcī, patefactum","to make open, open; disclose, expose"],["nuntiō, nuntiāre, nuntiāvī, nuntiātum","to announce, report, relate"],["sperō, sperāre, sperāvī, sperātum","to hope for, hope"],["putō, putāre, putāvī, putātum","to reckon, suppose, judge, think, imagine"],["suscipiō, suscipere, suscēpī, susceptum","to undertake"]];

  } else if (x==26){
    vocArry = [["cēna, cēnae, f.","dinner"],["forum, forī, n.","marketplace, forum"],["lēx, lēgis, f.","law, statute"],["līmen, līminis, n.","threshold"],["lūx, lūcis, f.","light"],["mēnsa, mēnsae, f.","table; dining; dish, course"],["nox, noctis, f.","night"],["somnus, somnī, m.","sleep"],["quīdam, quaedam, quiddam or quoddam","a certain one or thing, someone, someting; a certain, some"],["pudīcus, pudīca, pudīcum","modest, chaste"],["superbus, superba, superbum","arrogant, overbearing, haughty, proud"],["trīstis, trīstis, trīste","sad, sorrowful; joyless, grim, severe"],["turpis, turpis, turpe","ugly; shameful, base, disgraceful"],["urbānus, urbāna, urbānum","of the city urban; urbance, elegant"],["prae (+ ABL.)","in front of before"],["quam","than; as ... as possible; how"],["tantum","only"],["invītō, invītāre, invītāvī, invītātum","to entertain, invite, summon"]];
